"""
Revision ID: 19899c4516b1
Revises: 
Create Date: 2025-11-10 07:22:50.163341
...
def upgrade():
    ...
    sa.Column('etiquetas', sa.String(length=1000), nullable=True),
    ...
    sa.Column('profile_image', sa.String(length=1000000), nullable=True),
    sa.ForeignKeyConstraint(['id_pais'], ['paises.id_pais'], ),
    ...
    sa.Column('visibilidad', sa.Enum('publico', 'privado', name='visibilidad_chat'), nullable=True),
    sa.Column('descripcion', sa.Text(), nullable=True),
    ...
    sa.Column('cop_usd', sa.DECIMAL(precision=15, scale=2), nullable=True),
    sa.Column('cop_eur', sa.DECIMAL(precision=15, scale=2), nullable=True),
    ...
    sa.Column('id_comentario', sa.Integer(), autoincrement=True, nullable=False),
    sa.Column('id_user', sa.Integer(), nullable=True),
    sa.Column('id_foro', sa.Integer(), nullable=True),
    sa.Column('contenido', sa.Text(), nullable=True),
    sa.Column('estado', sa.Enum('activo', 'eliminado', name='estado_comentario'), nullable=True),
    sa.Column('fecha_creacion', sa.TIMESTAMP(), server_default=sa.text('now()'), nullable=True),
    sa.ForeignKeyConstraint(['id_foro'], ['foro.id_foro'], ),
    sa.ForeignKeyConstraint(['id_user'], ['users.id_user'], ),
    sa.PrimaryKeyConstraint('id_comentario')
    )
